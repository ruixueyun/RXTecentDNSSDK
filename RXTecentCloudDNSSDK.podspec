...
Pod::Spec.new do |s|
  s.name             = 'RXTecentCloudDNSSDK'
  s.version          = '1.0.1'
  s.summary          = 'ruixue RXTecentCloudDNSSDK framework.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/ruixueyun/RXTecentDNSSDK'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  #s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'ruixue' => 'xingdonghai@weile.com' }
  s.source           = { :git => 'https://github.com/ruixueyun/RXTecentDNSSDK.git', :tag => s.version.to_s }
